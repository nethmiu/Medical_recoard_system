...
if ($_SESSION['role'] !== 'doctor') {
    echo "<script>alert('Access denied. Doctors only.'); window.location.href='login.php';</script>";
    exit;
}
...
body::before {
    ...
    background-image: 
        ...
        radial-gradient(circle at 40% 80%, rgba(41, 128, 185, 0.2) 0%, transparent 50%);
    pointer-events: none;
}
...
.form-container::before {
    ...
    height: 4px;
    background: linear-gradient(90deg, #4cafef, #2980b9, #6dd5fa);
}
...
.doctor-icon {
    width: 90px;
    height: 90px;
    background: url('src/doctor.png') no-repeat center/cover;
    border-radius: 50%;
    margin: 0 auto 20px;
...
.btn1 {
    width: 100%;
    background: linear-gradient(135deg, #ac42ddff 0%, #b70cfaff 100%);
    color: white;
    padding: 16px 24px;
    border-radius: 12px;
    border: none;
...
.btn1:hover {
    background: linear-gradient(135deg, #b12bbdff 0%, #871acfff 100%);
...
<div class="container">
    <div class="doctor-header">
        ...
        <p class="subtitle">Secure your doctor account</p>
    </div>
